...
export const register = (username, email, password) => new Promise((res, rej) => {
...
export const confirmRegistration = (username, code) => new Promise((res, rej) => {
...
export const login = (username, password) => new Promise((res, rej) => {
  const user = new CognitoUser({ Pool: pool, Username: username });
...
export const logout = () => new Promise(res => {
  const user = pool.getCurrentUser();
  user && user.signOut();
  res();
});

export const getToken = () => new Promise((res, rej) => {
